...
//!
//! Deliberately hand-rolled rather than pulling the `image` crate into the
//! public surface: the app only ever needs an RGBA8 rectangle and a grayscale
//! projection of it.
...
impl Rgba8 {
    ...
    ///
    /// Box averaging rather than nearest-neighbour because this is used for the
    /// on-screen backdrop, where dropped pixels would alias badly on text.
